...
describe('Pagination Helpers', () => {
    ...
    describe('#Pagination', () => {
        ...
        it('#sleep should be a Promise object and not return values', async () => {
            ...
            const time = 1
            const pedingPromise = Pagination.sleep(time)
            clock.tick(time)

            assert.ok(pedingPromise instanceof Promise)
            const result = await pedingPromise
        ...
        describe('#handleRequest', () => {
            it('should retry a request twice before throing an exception and validate request params and flow', async() => {
                ...
                const dataRequest = { url: 'https://testing.com', page: 0 }
            ...
            it('should return data from request when succeded', async () => {
                ...
                const result = await pagination.handleRequest({ url: 'https://testing.com', page: 1 })
        ...
        describe('#getPaginated', () => {
            ...
            it('should update request id on each request', async () => {
                ...
                const data = { url: 'https://testing.com', page: 1 }
                ...
                // r.next() => { done: true, value: {} }
                // a melhor forma é usar for ... of
